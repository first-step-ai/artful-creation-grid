    ...
    <section id="top" className="relative isolate min-h-[92vh] md:min-h-screen overflow-hidden">
      ...
      >
        <div className="max-w-4xl">
          <h1 className="font-serif italic font-light text-ivory text-[2.25rem] leading-[1.05] sm:text-5xl md:text-6xl lg:text-7xl tracking-normal [text-shadow:0_2px_18px_rgba(0,0,0,0.75)]">
