    ...
    <section id="top" className="relative isolate min-h-[92vh] md:min-h-screen overflow-hidden">
      ...
      >
        <div className="max-w-4xl">
          <h1 className="font-sans font-light text-ivory uppercase tracking-[0.12em] leading-[1.2] text-2xl sm:text-3xl md:text-4xl lg:text-5xl [text-shadow:0_2px_18px_rgba(0,0,0,0.75)]">
