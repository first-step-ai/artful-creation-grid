  ...
  return (
    <article className="group lift">
      ...
      <div className="mt-4 flex items-start justify-between gap-6">
        <div>
          <h3 className="font-serif italic text-2xl md:text-3xl text-brass font-light tracking-[0.12em] uppercase">
            {title}
          </h3>
          <p className="mt-2 max-w-sm text-sm text-white leading-relaxed">{body}</p>
        </div>
