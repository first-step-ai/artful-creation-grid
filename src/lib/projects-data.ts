...
import bexley3 from "@/assets/projects/bexley-v2-3b.jpg.asset.json";
...
import putneyBefore3 from "@/assets/projects/putney-ba/putney-before-3-v2.jpg.asset.json";
...
import rze11land from "@/assets/projects/rozelle-ensuite-study/rze-11-landscape.jpg.asset.json";
...
import rwhHero from "@/assets/projects/rozelle-whole/rozelle-whole-hero.png.asset.json";
...
export const projects: ProjectSummary[] = [
  ...
  { suburb: "Rozelle", title: "Bathroom Conversion", category: "Bathroom", image: rze1.url, tags: ["Bathroom"], archived: true },
  ...
  { suburb: "Drummoyne", title: "HIA-Recognised Kitchen and Bath", category: "Multi-Space", image: drumAw6.url, badge: "Finalist", tags: ["Multi-Space", "Kitchen", "Bathroom", "Laundry"] },
...
const detailOverrides: Record<string, Partial<ProjectDetail>> = {
  ...
  "drummoyne-soft-luxe-main-bathroom": {
    ...
    rightHeading: "Soft Luxe Main Bathroom",
    rightIntro:
      "A Drummoyne apartment main bathroom reimagined from the ground up. Within a fixed footprint, the goal was to improve function, add storage, and introduce warmth and softness, creating a calm, light-filled space properly suited to everyday living.",
    whatWasntWorking: [
      "Bathroom felt dated and narrow",
      "Layout worked against daily routines",
      "Limited storage and bench space",
      "Apartment footprint ruled out structural change",
      "Finishes felt cold and uninspiring",
    ],
    whatWeDid:
      "The main bathroom was redesigned to maximise function within the fixed footprint. Bespoke cabinetry and integrated storage transformed what felt constrained into a streamlined, calm space. Warm blush feature tiles, sculptural shower detailing, and refined brass fixtures introduced softness and depth, while subtle underfloor heating added comfort.",
    designFeatures: [
      "Full redesign of the main bathroom within a fixed footprint",
      "Bespoke vanity joinery with integrated storage",
      ...
      "Layered ambient and task lighting",
      "Subtle underfloor heating for comfort",
      "Streamlined layout improving circulation",
      "Light-filled finish despite compact proportions",
    ],
    gallery: [sl29.url, sl9.url, sl20.url, sl21.url, sl23.url, sl27.url, sl29.url],
  ...
  "drummoyne-award-winning-kitchen-and-bath": {
    ...
    awards: [
      ...
      "2023 HIA NSW Kitchen Design of the Year · Finalist",
      "2023 HIA NSW Renovated Kitchen · Finalist",
      "2022 HIA NSW Bathroom Design of the Year · Finalist",
      "2022 HIA NSW New Bathrooms over $25K · Finalist",
    ],
    rightHeading: "HIA-Recognised Kitchen and Bath",
    rightIntro:
      "A Drummoyne renovation recognised across five HIA NSW awards as a finalist, pairing a refined kitchen with a thoughtfully resolved new bathroom.",
    whatWasntWorking: [
  ...
  "five-dock-family-bathroom-and-bedroom-storage": {
    ...
    gallery: [fd05L.url, fd39L.url, fd10p.url, fd11p.url, fd28L.url, fd16p.url, fd18p.url, fd36L.url, fd21p.url, fd23p.url, fd25p.url, fd27p.url, fd29p.url, fd30p.url, fd31p.url, fd38p.url],
