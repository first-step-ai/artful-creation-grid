...
export const Route = createFileRoute("/awards-v2")({
  head: () => ({
    meta: [
      { title: "Awards (v2) | AM Bathrooms + Projects" },
      {
        name: "description",
        content:
          "Alternate awards layout — centered cards with auto-transition.",
      },
      { property: "og:title", content: "Awards (v2) | AM Bathrooms + Projects" },
      {
        property: "og:description",
        content: "Alternate awards layout — centered cards with auto-transition.",
      },
      { property: "og:image", content: rozelle1.url },
      { name: "twitter:image", content: rozelle1.url },
    ],
  }),
  component: AwardsV2Page,
});
